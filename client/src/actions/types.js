...
//Volunteer
//Area
export const ADD_EMPTY_VOLUNTEER = "ADD_EMPTY_VOLUNTEER";
...
export const SORT_BY_VOLUNTEER = "SORT_BY_VOLUNTEER";
export const SORT_BY_NEW_VOLUNTEER = "SORT_BY_NEW_VOLUNTEER";
export const VOLUNTEER_LOADED = "VOLUNTEER_LOADED";
export const UPDATE_VOLUNTEER_ADMIN = "UPDATE_VOLUNTEER_ADMIN";

//Volunteer History
export const GET_VOLUNTEER_HISTORY = "GET_VOLUNTEER_HISTORY";
export const SORT_BY_VOLUNTEER_HISTORY = "SORT_BY_VOLUNTEER_HISTORY";
export const SORT_BY_NEW_VOLUNTEER_HISTORY = "SORT_BY_NEW_VOLUNTEER_HISTORY";
